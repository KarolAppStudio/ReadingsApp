...
class ReadingRepository(private val bibleDao: BibleDao, private val planDao: ReadingPlanDao) {
    private val bookNameToId =
        mapOf(
            ...
            "Philippians" to 49,
            "Colossians" to 50,
            "1 Thessalonians" to 51,
            "2 Thessalonians" to 52,
            "1 Timothy" to 53,
            "2 Timothy" to 54,
            "Titus" to 55,
            "Philemon" to 56,
    ...
    suspend fun getReadingsForDate(
        date: String,
        translationCode: String = "ENG",
    ): Map<String, List<TargetReadingDetails>> = withContext(Dispatchers.IO) {
    ...
    private suspend fun parseReading(
        readingStr: String,
        type: String,
        date: String,
    ...
    private val standardChapterCounts = listOf(
        ...
        14, 3, 9, 1, 4, 7, 3, 3, 3, 2, 14, 4, 28, 16, 24, 21, 28, 16, 16, 13, 6, 6, 4, 4, 5, 3, 6, 4, 3, 1, 13,
        5, 5, 3, 5, 1, 1, 1, 22,
    )
