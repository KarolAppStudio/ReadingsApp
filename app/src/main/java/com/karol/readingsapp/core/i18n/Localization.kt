...
object Localization {
    ...
    private val Telugu =
        LocalizedStrings(
            ...
            downloaded = "ఇన్‌స్టాల్ చేయబడింది",
    ...
    private val Farsi =
        LocalizedStrings(
            ...
            developerNoteContent = "عمیق‌ترین قدردانی ما از خداوند متعال برای این فرصت جهت " +
                "خلق چیزی معنادار برای جامعه.",
            appDescription = "برنامه‌ای ساده برای کمک به شما در دنبال کردن برنامه خواندن روزانه کتاب مقدس " +
                "با پشتیبانی از چندین ترجمه.",
    ...
    fun registerDynamicLocalization(code: String, json: String) {
        try {
            ...
            val strings = LocalizedStrings(
                ...
                downloads = obj.optString("downloads", English.downloads),
