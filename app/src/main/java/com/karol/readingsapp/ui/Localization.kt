...
object Localization {
    ...
    private val English =
        LocalizedStrings(
            ...
            developerNoteContent = "First and foremost, we express our sincere gratitude to the Almighty for blessing us with the opportunity to create something meaningful for the community. I would also like to extend my heartfelt gratitude to all the wonderful individuals who generously dedicated their valuable time and effort to testing, sharing feedback, and offering thoughtful suggestions while developing this app. Your encouragement, support, and contributions have been invaluable, and they played an essential role in making this effort a success.",
            appDescription = "A simple app to help you follow your daily Bible reading plan with multiple translations support.",
            copyrightNotice = "Bible translations included in this app are copyrighted by their respective publishers and copyright holders. All rights remain with their respective owners.",
    ...
    private val Bangla =
        LocalizedStrings(
            ...
            developerNoteContent = "প্রথমত এবং সর্বাগ্রে, আমরা সর্বশক্তিমানের প্রতি আমাদের আন্তরিক কৃতজ্ঞতা প্রকাশ করছি আমাদের এই সুযোগ দেওয়ার জন্য যাতে আমরা সমাজের জন্য অর্থবহ কিছু তৈরি করতে পারি। আমি সেই সব চমৎকার ব্যক্তিদেরও আমার আন্তরিক কৃতজ্ঞতা জানাতে চাই যারা এই অ্যাপটি তৈরির সময় তাদের মূল্যবান সময় এবং প্রচেষ্টা ব্যয় করে এটি পরীক্ষা করেছেন, মতামত শেয়ার করেছেন এবং গঠনমূলক পরামর্শ দিয়েছেন। আপনাদের উৎসাহ, সমর্থন এবং অবদান অমূল্য ছিল এবং এই প্রচেষ্টাকে সফল করতে এটি একটি অপরিহার্য ভূমিকা পালন করেছে।",
    ...
    private val Hindi =
        LocalizedStrings(
            ...
            developerNoteContent = "सबसे पहले और सबसे महत्वपूर्ण, हम सर्वशक्तिमान के प्रति अपनी सच्ची कृतज्ञता व्यक्त करते हैं कि उन्होंने हमें समुदाय के लिए कुछ सार्थक बनाने का अवसर प्रदान किया। मैं उन सभी अद्भुत व्यक्तियों के प्रति भी अपना हार्दिक आभार व्यक्त करना चाहता हूं जिन्होंने इस ऐप को विकसित करने के दौरान परीक्षण करने, फीडबैक साझा करने और विचारशील सुझाव देने के लिए अपना बहुमूल्य समय और प्रयास उदारतापूर्वक समर्पित किया। आपका प्रोत्साहन, समर्थन और योगदान अमूल्य रहा है, और इस प्रयास को सफल बनाने में आपकी अनिवार्य भूमिका रही है।",
    ...
    private val Kannada =
        LocalizedStrings(
            ...
            developerNoteContent = "ಮೊದಲನೆಯದಾಗಿ ಮತ್ತು ಪ್ರಮುಖವಾಗಿ, ಸಮುದಾಯಕ್ಕಾಗಿ ಅರ್ಥಪೂರ್ಣವಾದದ್ದನ್ನು ರಚಿಸಲು ನಮಗೆ ಅವಕಾಶವನ್ನು ನೀಡಿದ ಆ ಸರ್ವಶಕ್ತನಿಗೆ ನಾವು ನಮ್ಮ ಪ್ರಾಮಾಣಿಕ ಕೃತಜ್ಞತೆಯನ್ನು ವ್ಯಕ್ತಪಡಿಸುತ್ತೇವೆ. ಈ ಆಪ್ ಅನ್ನು ಅಭಿವೃದ್ಧಿಪಡಿಸುವಾಗ ಪರೀಕ್ಷಿಸಲು, ಅಭಿಪ್ರಾಯಗಳನ್ನು ಹಂಚಿಕೊಳ್ಳಲು ಮತ್ತು ಉಪಯುಕ್ತ ಸಲಹೆಗಳನ್ನು ನೀಡಲು ತಮ್ಮ ಅಮೂಲ್ಯ ಸಮಯ ಮತ್ತು ಶ್ರಮವನ್ನು ಧಾರಾಳವಾಗಿ ಮೀಸಲಿಟ್ಟ ಎಲ್ಲಾ ಅದ್ಭುತ ವ್ಯಕ್ತಿಗಳಿಗೆ ನಾನು ನನ್ನ ಹೃತ್ಪೂರ್ವಕ ಕೃತಜ್ಞತೆಯನ್ನು ಅರ್ಪಿಸಲು ಬಯಸುತ್ತೇನೆ. ನಿಮ್ಮ ಪ್ರೋತ್ಸಾಹ, ಬೆಂಬಲ ಮತ್ತು ಕೊಡುಗೆಗಳು ಅತ್ಯಮೂಲ್ಯವಾಗಿದ್ದು, ಈ ಪ್ರಯತ್ನವನ್ನು ಯಶಸ್ವಿಗೊಳಿಸುವಲ್ಲಿ ಅವು ಅತ್ಯಗತ್ಯ ಪಾತ್ರವನ್ನು ವಹಿಸಿವೆ.",
    ...
    private val Malayalam =
        LocalizedStrings(
            ...
            developerNoteContent = "ഏറ്റവും ആദ്യമായി, സമൂഹത്തിന് അർത്ഥവത്തായ എന്തെങ്കിലും സൃഷ്ടിക്കാൻ ഞങ്ങൾക്ക് അവസരം നൽകിയ സർവ്വശക്തനോട് ഞങ്ങൾ হൃദയപൂർവ്വം നന്ദി പറയുന്നു. ഈ ആപ്പ് വികസിപ്പിക്കുന്ന വേളയിൽ, പരിശോധനകൾ നടത്താനും, അഭിപ്രായങ്ങൾ പങ്കുവെക്കാനും, ക്രിയാത്മകമായ നിർദ്ദേശങ്ങൾ നൽകാനും തങ്ങളുടെ വിലയേറിയ സമയവും പരിശ്രമവും ഉദാരമായി മാറ്റിവെച്ച എല്ലാ വ്യക്തികളോടും ഞാൻ എന്റെ ആത്മാർത്ഥമായ നന്ദി അറിയിക്കുന്നു. നിങ്ങളുടെ പ്രോത്സാഹനവും പിന്തുണയും സംഭാവനകളും അമൂല്യമാണ്, കൂടാതെ ഈ ശ്രമം വിജയിപ്പിക്കുന്നതിൽ അവ നിർണ്ണായക പങ്കുവഹിച്ചു.",
    ...
    private val Tamil =
        LocalizedStrings(
            ...
            developerNoteContent = "முதன்மையாகவும் மிக முக்கியமாகவும், சமுதாயத்திற்காக அர்த்தமுள்ள ஒன்றை உருவாக்குவதற்கான வாய்ப்பை எங்களுக்கு வழங்கிய இறைவனுக்கு எங்களது மனமார்ந்த நன்றியைத் தெரிவித்துக் கொள்கிறோம். இந்த செயலியை உருவாக்கும் போது சோதனை செய்தல், கருத்துகளைப் பகிர்தல் மற்றும் பயனுள்ள ஆலோசனைகளை வழங்குதல் ஆகியவற்றிற்காகத் தங்களது பொன்னான நேரத்தையும் உழைப்பையும் தாராளமாக வழங்கிய அனைத்து நற்பண்பு கொண்ட உள்ளங்களுக்கும் எனது மனமார்ந்த நன்றியைத் தெரிவித்துக் கொள்கிறேன். உங்களது ஊக்கம், ஆதரவு மற்றும் பங்களிப்புகள் விலைமதிப்பற்றவை, மேலும் இந்த முயற்சியை வெற்றிகரமாக மாற்றுவதில் அவை முக்கிய பங்கு வகித்துள்ளன.",
    ...
    private val Telugu =
        LocalizedStrings(
            ...
            developerNoteContent = "ముందుగా, సమాజానికి అర్థవంతమైనదాన్ని సృష్టించే అవకాశాన్ని మాకు ప్రసాదించిన ఆ సర్వశక్తిమంతునికి మా హృదయపూర్వక కృతజ్ఞతలు తెలియజేస్తున్నాము. ఈ యాప్‌ను అభివృద్ధి చేసే క్రమంలో పరీక్షించడం, ఫీడ్ బ్యాక్ పంచుకోవడం మరియు విలువైన సలహాలను అందించడం కోసం తమ విలువైన సమయాన్ని మరియు శ్రమను వెచ్చించిన అద్భుతమైన వ్యక్తులందరికీ నేను నా కృతజ్ఞతలు తెలియజేస్తున్నాను. మీ ప్రోత్సాహం, మద్దతు మరియు సహకారం వెలకట్టలేనివి మరియు ఈ ప్రయత్నం విజయవంతం కావడంలో అవి కీలక పాత్ర పోషాయి.",
