...
data class LocalizedStrings(
    ...
    val themeLiquidFrostedGlass: String,
...
object Localization {
    ...
    private val English =
        LocalizedStrings(
            ...
            developerNoteContent = "Our deepest gratitude to Our Almighty LORD for the opportunity to create something meaningful for the community. A huge thank you also goes out to all our testers and users. Your feedback, suggestions, and support kept us going and truly made this app a success. We couldn’t have done it without you!",
            ...
            themePurple = "Purple",
            themeSepia = "Sepia",
            themeLiquidFrostedGlass = "Liquid Frosted Glass",
    ...
    private val Bangla =
        LocalizedStrings(
            ...
            developerNoteContent = "সমাজের জন্য অর্থবহ কিছু তৈরি করার সুযোগ দেওয়ার জন্য আমরা সর্বশক্তিমান প্রভুর প্রতি আমাদের গভীর কৃতজ্ঞতা প্রকাশ করছি। আমাদের সমস্ত পরীক্ষক এবং ব্যবহারকারীদেরও অনেক ধন্যবাদ। আপনাদের মতামত, পরামর্শ এবং সমর্থন আমাদের এগিয়ে যেতে সাহায্য করেছে এবং এই অ্যাপটিকে সফল করে তুলেছে। আপনাদের ছাড়া আমরা এটি করতে পারতাম না!",
            ...
            themePurple = "বেগুনী",
            themeSepia = "সেপিয়া",
            themeLiquidFrostedGlass = "লিকুইড ফ্রস্টেড গ্লাস",
    ...
    private val Hindi =
        LocalizedStrings(
            ...
            developerNoteContent = "समुदाय के लिए कुछ सार्थक बनाने का अवसर देने के लिए हम अपने सर्वशक्तिमान प्रभु के प्रति अत्यंत आभारी हैं। हमारे सभी परीक्षकों और उपयोगकर्ताओं को भी बहुत-बहुत धन्यवाद। आपकी प्रतिक्रिया, सुझावों और समर्थन ने हमें निरंतर प्रेरित किया और वास्तव में इस ऐप को एक सफलता बनाया। हम आपके बिना यह नहीं कर सकते थे!",
            ...
            themePurple = "बैंगनी",
            themeSepia = "सेपिया",
            themeLiquidFrostedGlass = "लिक्विड फ्रॉस्टेड ग्लास",
    ...
    private val Kannada =
        LocalizedStrings(
            ...
            developerNoteContent = "ಸಮುದಾಯಕ್ಕಾಗಿ ಅರ್ಥಪೂರ್ಣವಾದುದನ್ನು ಸೃಷ್ಟಿಸಲು ನಮಗೆ ಅವಕಾಶ ನೀಡಿದ ಆ ಸರ್ವಶಕ್ತ ದೇವರಿಗೆ ನಮ್ಮ ಅನಂತ ಕೃತಜ್ಞತೆಗಳು. ನಮ್ಮೆಲ್ಲಾ ಪರೀಕ್ಷಕರಿಗೆ ಮತ್ತು ಬಳಕೆದಾರರಿಗೂ ದೊಡ್ಡ ಧನ್ಯವಾದಗಳು. ನಿಮ್ಮ ಪ್ರತಿಕ್ರಿಯೆ, ಸಲಹೆಗಳು ಮತ್ತು ಬೆಂಬಲವು ನಮ್ಮನ್ನು ಮುನ್ನಡೆಸಿತು ಮತ್ತು ಈ ಆಪ್ ಅನ್ನು ನಿಜವಾಗಿಯೂ ಯಶಸ್ವಿಗೊಳಿಸಿತು. ನಿಮ್ಮಿಲ್ಲದೆ ನಾವು ಇದನ್ನು ಮಾಡಲು ಸಾಧ್ಯವಿರಲಿಲ್ಲ!",
            ...
            themePurple = "ನೇರಳೆ",
            themeSepia = "ಸೆಪಿಯಾ",
            themeLiquidFrostedGlass = "ಲಿಕ್ವಿಡ್ ಫ್ರಾಸ್ಟೆಡ್ ಗ್ಲಾಸ್",
    ...
    private val Malayalam =
        LocalizedStrings(
            ...
            developerNoteContent = "സമൂഹത്തിനായി അർത്ഥവത്തായ ഒന്ന് സൃഷ്ടിക്കാൻ ഞങ്ങൾക്ക് അവസരം നൽകിയ സർവ്വശക്തനായ ദൈവത്തോട് ഞങ്ങൾ അങ്ങേയറ്റം കടപ്പെട്ടിരിക്കുന്നു. ഞങ്ങളുടെ എല്ലാ ടെസ്റ്റർമാർക്കും ഉപയോക്താക്കൾക്കും വലിയൊരു നന്ദി. നിങ്ങളുടെ അഭിപ്രായങ്ങളും നിർദ്ദേശങ്ങളും പിന്തുണയും ഞങ്ങളെ മുന്നോട്ട് നയിക്കുകയും ഈ ആപ്പിനെ യഥാർത്ഥത്തിൽ വിജയകരമാക്കുകയും ചെയ്തു. നിങ്ങളില്ലാതെ ഞങ്ങൾക്ക് ഇത് ചെയ്യാൻ കഴിയുമായിരുന്നില്ല!",
            ...
            themePurple = "പർപ്പിൾ",
            themeSepia = "സെപ്പിയ",
            themeLiquidFrostedGlass = "ലിക്വിഡ് ഫ്രോസ്റ്റഡ് ഗ്ലാസ്",
    ...
    private val Tamil =
        LocalizedStrings(
            ...
            developerNoteContent = "சமுதாயத்திற்காக அர்த்தமுள்ள ஒன்றை உருவாக்குவதற்கான வாய்ப்பை வழங்கிய இறைவனுக்கு எங்களது மனமார்ந்த நன்றியைத் தெரிவித்துக் கொள்கிறோம். எங்களது சோதனையாளர்கள் மற்றும் பயனர்கள் அனைவருக்கும் மிகப்பெரிய நன்றிகள். உங்களது கருத்துக்கள், ஆலோசனைகள் மற்றும் ஆதரவு எங்களைத் தொடர்ந்து இயங்க வைத்ததுடன், இந்த செயலியை உண்மையிலேயே வெற்றிகரமானதாக மாற்றியது. நீங்கள் இல்லாமல் எங்களால் இதைச் செய்திருக்க முடியாது!",
            ...
            themePurple = "ஊதா",
            themeSepia = "செபியா",
            themeLiquidFrostedGlass = "லிக்விட் ஃப்ரோஸ்டட் கிளாஸ்",
    ...
    private val Telugu =
        LocalizedStrings(
            ...
            developerNoteContent = "సమాజానికి అర్థవంతమైనదాన్ని సృష్టించే అవకాశాన్ని మాకు ప్రసాదించిన ఆ సర్వశక్తిమంతుడైన ప్రభువుకు మా హృదయపూర్వక కృతజ్ఞతలు. మా టెస్టర్లకు మరియు వినియోగదారులందరికీ కూడా పెద్ద ధన్యవాదాలు. మీ ఫీడ్‌బ్యాక్, సలహాలు మరియు మద్దతు మమ్మల్ని ముందుకు నడిపించాయి మరియు ఈ యాప్‌ను నిజంగా విజయవంతం చేశాయి. మీరు లేకుండా మేము దీనిని సాధించలేకపోయేవాళ్ళము!",
            ...
            themePurple = "పర్పుల్",
            themeSepia = "సెపియా",
            themeLiquidFrostedGlass = "లిక్విడ్ ఫ్రాస్టెడ్ గ్లాస్",
